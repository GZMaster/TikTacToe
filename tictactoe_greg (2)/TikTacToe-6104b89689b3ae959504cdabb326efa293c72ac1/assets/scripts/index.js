...
function checkWinner(sign) {
  ...
  for (var i in item) {
    if (
      item[0].children[0] !== undefined &&
      item[0].id === "A1" &&
      item[0].children[0].id === sign.id &&
      item[1].children[0] !== undefined &&
      item[1].id === "A2" &&
      item[1].children[0].id === sign.id &&
      item[2].children[0] !== undefined &&
      item[2].id === "A3" &&
      item[2].children[0].id === sign.id
    ) {
      pass = true;
      break;
    } else if (
      item[3].children[0] !== undefined &&
      item[3].id === "B1" &&
      item[3].children[0].id === sign.id &&
      item[4].children[0] !== undefined &&
      item[4].id === "B2" &&
      item[4].children[0].id === sign.id &&
      item[5].children[0] !== undefined &&
      item[5].id === "B3" &&
      item[5].children[0].id === sign.id
    ) {
      pass = true;
      break;
    } else if (
      item[6].children[0] !== undefined &&
      item[6].id === "C1" &&
      item[6].children[0].id === sign.id &&
      item[7].children[0] !== undefined &&
      item[7].id === "C2" &&
      item[7].children[0].id === sign.id &&
      item[8].children[0] !== undefined &&
      item[8].id === "C3" &&
      item[8].children[0].id === sign.id
    ) {
      pass = true;
      break;
    } else if (
